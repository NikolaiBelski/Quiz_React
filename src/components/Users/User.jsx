...
export const User = ({id,email,first_name,last_name,avatar,onChangeInvise,inSet}) => (
  <li>
    <div>
    ...
    <img className="action" src={`/assets/${inSet?'minus':'plus'}.svg`} alt="A" onClick={()=>onChangeInvise(id)}/>
  </li>
);